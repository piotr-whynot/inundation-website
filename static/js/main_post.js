...
function initialize () {
    ...
    txt+="<input type=text class='form-control contained' id=expCode>";
    txt+="</div>";
    txt+="<div class=form-group>";
...
//    txt+="<input type=button class='btn btn-info' value='Load previous experiment'>";
    ...
    txt+="<input class='form-control' type='text' id=inputFileName disabled>";
    ...
    txt+="<input type=text name=expID hidden value="+expID+">";
    txt+="</form>";
    ...
    txt+="  <div class='input-group'>";
    txt+="   <input class='form-control' type='text' id=paramFileName disabled>";
    txt+="   <div class='input-group-btn'>";
    ...
    txt+="  <input type=text name=expID value="+expID+" hidden>";
    txt+=" </div>";
    txt+="</form>";
    ...
    txt+="<div class='input-group'>";
    txt+="<input class='form-control' type='text' id=initcondFileName disabled>";
    txt+="<div class='input-group-btn'>";
    ...
    txt+="</div>";
    txt+="<div id=optrunConfig>";
    txt+="<input type=text name=expID value="+expID+">";
    txt+="<p>Parameters file: <span id=serverparamFileName></span><input type=text name=serverparamFile id=serverparamFile hidden>";
    txt+="<p>Initial conditions file:<span id=serverinitcondFileName></span><input type=text name=serverinitcondFile id=serverinitcondFile hidden>";
    txt+="<p>Input data file: <span id=serverinputFileName></span><input type=text name=serverinputFile id=serverinputFile hidden>";
    txt+="<p>for the period from: <span id=firstDate></span> to <span id=lastDate></span> covering <span id=nts></span> monthly time steps";
    ...
    for (var key in outputsList){
        txt+="<div class=checkbox><label><input class=activeInput type=checkbox name=outputs[] value="+key+"."+outputsList[key][2]+" id="+key+" "+outputsList[key][1]+">"+outputsList[key][0]+"</label></div>";
    }
    txt+="</div>";
    txt+="</form>";
    ...
    txt+="<input type=button class='btn btn-primary mx-1 my-1 disabled' id=runmodelButton value='Run model'>";
    txt+="</form>";
